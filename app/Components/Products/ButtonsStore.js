  ...
  return (
    <View style={styles.buttonsCat}>
      <TouchableOpacity onPress={() => SelectCategory("lunch")}>
        <View style={[styles.buttonCategory, { backgroundColor: getColor("lunch") }]}>
          <Image
      ...
      <TouchableOpacity onPress={() => SelectCategory("drinks")}>
        <View style={[styles.buttonCategory, { backgroundColor: getColor("drinks") }]}>
          <Image
      ...
      <TouchableOpacity onPress={() => SelectCategory("gifts")}>
        <View style={[styles.buttonCategory, { backgroundColor: getColor("gifts") }]}>
          <Image
